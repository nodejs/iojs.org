...
La versione {{project.current_version}} di io.js viene rilasciata con la versione {{project.current_v8}} del motote V8, che include caratteristiche di ES6 più avanzate rispetto alla versione 3.26.33 che è stata rilasciata assieme a joyent/node@0.12.x.
