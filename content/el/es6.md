...
Η έκδοση {{project.current_version}} της io.js έρχεται μαζί με την έκδοση {{project.current_v8}} της V8, η οποία περιλαμβάνει χαρακτηριστικά από την ES6, πολύ περισσότερα από την έκδοση 3.26.33 που προσφέρετε από την joyent/node@0.12.x.
