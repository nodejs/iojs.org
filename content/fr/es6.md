...
Avec joyent/node@0.12.x (V8 3.26), l'option `--harmony` activait toutes les fonctionnalités ES6 ensembles, qu'elles soient **complétées**, **en phase d'acceptation** ou **en développement**.
