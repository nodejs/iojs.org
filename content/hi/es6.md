...
Version {{iojs.value}} of io.js ships with V8 {{V8.value}}, which includes ES6 features well beyond version 3.26.33 that will be shipped with joyent/node@0.12.x.
