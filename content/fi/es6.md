...
io.js:n versio {{project.current_version}} sisältää V8 version {{project.current_v8}}, mikä ES6:n osalta ylittää tuntuvasti ominaisuuksiltaan version 3.28.72 mikä sisältyy Node.js™ 0.12.x-versioihin.
