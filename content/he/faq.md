...
מטרת הפרוייקט היא להמשיך את הפיתוח של io.js תחת מודל "[ממשל פתוח](https://github.com/nodejs/io.js/blob/v1.x/GOVERNANCE.md#readme)", בניגוד לשליטה ע"י קואופרטיב או חברה.
...
כל אחד יכול לעזור. io.js שומר על [קוד התנהגות](https://github.com/nodejs/io.js/blob/v1.x/CONTRIBUTING.md#code-of-conduct), וכל התרומות והשחרורים הם תחת מודל [הממשל הפתוח](https://github.com/nodejs/io.js/blob/v1.x/GOVERNANCE.md#readme).

בשביל להתחיל, [יש דיונים פתוחים בGitHub (אנגלית)](https://github.com/nodejs/io.js/issues), ונשמח לקבל מכם משוב. להשתתף בדיונים היא דרך נהדרת לקבל מושג של איפה תוכלו לעזור יותר. אם יש משהו שאתם חושבים שתוכלו לטפל בו, נשמח ל[pull request](https://github.com/nodejs/io.js/blob/v1.x/CONTRIBUTING.md#code-contributions) מכם.
